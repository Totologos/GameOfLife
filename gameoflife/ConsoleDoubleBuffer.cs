...
namespace DoubleBuffer
{
    ...
    class ConsoleDoubleBuffer 
    {
        ...
        public void Print() //Paint the image
        {
            if (!h.IsInvalid)
            {
                ...
                bool b = NativeMethods.WriteConsoleOutput(h, buf, new Coord((short)width, (short)height), new Coord((short)0, (short)0), ref rect);
            }
        }
        /// <summary>
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern bool WriteConsoleOutput(
          ...
          ConsoleDoubleBuffer.CharInfo[] lpBuffer,
          ConsoleDoubleBuffer.Coord dwBufferSize,
          ConsoleDoubleBuffer.Coord dwBufferCoord,
          ref ConsoleDoubleBuffer.SmallRect lpWriteRegion);
    }
}
